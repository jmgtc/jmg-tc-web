...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/consultoria-tecnologica-getxo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  { url: `${BASE_URL}/servicios/inteligencia-artificial-empresas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/servicios/desarrollo-web-medida`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/servicios/automatizacion-procesos`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/servicios/soporte-mac-negocios`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/diagnostico-tecnologico`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
